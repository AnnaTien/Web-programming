...
var Transaction = {
  ...
  gettransactionById: function (user_id, callback) {
    return db.query("select * from transaction where user_id=?", [user_id], callback);
  },
  ...
  deletetransaction: function (transaction_id, callback) {
    return db.query("delete from transaction where user_id=?", [transaction_id], callback);
  },
